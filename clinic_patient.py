...
# Clinic Patient Class - to store all details of patient entry
class ClinicPatient:
    def __init__(self, CHI: str, appt_time: time, first_name, last_name):
        self._CHI = CHI
        self.appt_time = appt_time
        self._summary = "No Previous clinic found"
        self._last_seen = None
        self._first_name = first_name
        self._last_name = last_name

    # Getter and setter for _CHI - and logic to deal with single digit date of births
    @property
    def CHI(self):
        if len(self._CHI) < 10:
            self._CHI = "0" + self._CHI
        return self._CHI
...
if __name__ == "__main__":
    ...
    clinic = ClinicPatient("23456789", "15:30:00", "sam", "mcinerney")
    clinic.summary = (
